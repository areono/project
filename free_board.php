...
error_reporting(E_ALL);
    include 'header.php';
      ...
      // Function to construct the SQL query based on the sorting option
      ...
      // Get the sorted result from the database
...
$(document).ready(function() {
  ...
  $(".sort-btn").click(function() {
    ...
    window.location.href = "free_board.php?sort=" + currentSortBy + "&sortdir=" + currentSortDir;
  });
});
